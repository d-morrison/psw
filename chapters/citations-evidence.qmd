...
Reusing another writer's exact words —
...
When the passage you are tempted to copy already appears elsewhere
in your own document,
cross-reference it instead of repeating it.
Cross-referencing keeps a single source of truth
and improves concision.
